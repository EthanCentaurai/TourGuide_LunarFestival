...
F City of Ironforge |N|Fly or take the Deeprun Tram.|
...
T Hammershout the Elder |N|Outside Stormwind City, near the gates. (34.5,50.2)| |Z|Elwynn Forest|
T Stormbrow the Elder |N|Near the pond. (39.7,63.6)| |Z|Elwynn Forest|

F Westfall
T Skychaser the Elder |N|On top of the tower, north-east of Sentinel Hill. (56.6,47)| |Z|Westfall|

F The Temple of Atal'Hakkar |N|(69.6,53.6)| |Z|Swamp of Sorrows|
T Starsong the Elder |N|Inside the dungeon, at the end of a short corridor to the left.|

F Blasted Lands
T Bellowrage the Elder |N|North of the Dark Portal. (54.2,49.5)| |Z|Blasted Lands|

F Northern Stranglethorn
T Starglade the Elder |N|Near Zul'Gurub, in the courtyard in front of the steps up to instance entrance. (71,34.3)| |Z|Northern Stranglethorn|

F The Cape of Stranglethorn |N|Fly to Booty Bay.|
T Winterhoof the Elder |N|On top of the bank in Booty Bay. (39.9,72.5)| |Z|The Cape of Stranglethorn|

b Ratchet
T Windtotem the Elder |N|In Ratchet, outside of the Engineering building north of the bank. (68.3,69.9)| |Z|Northern Barrens|

F Durotar
T Runetotem the Elder |N|South-east edge of Razor Hill. (53.2,43.5)| |Z|Durotar|

F Orgrimmar |N|Yes, Alliance need to go to Horde cities. Luckily for you, Orgrimmar is the largest Horde city. And just like in Ironforge, the most crowded places is the bank, the mailbox and the auction house. Feel free to fly in, but beware of flying guard NPCs.|
...
F Thunder Bluff |N|Thunder Bluff is not a very big city, therefore you are much more likely to meet enemy players. However, Thunder Bluff isn't as popular as Orgrimmar is, so you are less likely to become overwhelmed.|
T Wheathoof the Elder |N|Elder Rise (72.9,23.1). In memoriam, Ezra Chatterton (1998-2008).| |Z|Thunder Bluff|
...
F Southern Barrens
T High Mountain the Elder |N|Outside of Vendetta Point. Don't worry, the flight master next to him "shouldn't" aggro as you get close... (41.5,47.5)| |Z|Southern Barrens|
...
F Zul'Farrak
T Wildmane the Elder |N|Inside the instance, in the room with Gahz'rilla's gong.|

F Tanaris |N|Exit the instance.|
T Ragetotem the Elder |N|Valley of the Watchers, west side. (37.2,79)| |Z|Tanaris|

F Un'Goro Crater
T Thunderhorn the Elder |N|North of the Slithering Scar. (50.3,76.2)| |Z|Un'Goro Crater|

F Uldum |N|Skip ahead to Silithus if you are below Level 83.|
T Menkhaf the Elder |N|Next to a closed door in Khartut's Tomb. (65.5,18.7)| |Z|Uldum|
T Sekhemi the Elder |N|In the Ruins of Ammon. (31.6,63)| |Z|Uldum|

F Silithus
T Bladesing the Elder |N|Standing in the Moon Well, Cenarion Hold. (53,35.4)| |Z|Silithus|
T Primestone the Elder |N|In the Crystal Vale, near the Ravaged Twilight Camp. (30.8,13.3)| |Z|Silithus|

F Feralas
T Mistwalker the Elder |N|Inside the Dire Maul arena. (62.5,31.1)| |Z|Feralas|
T Grimtotem the Elder |N|Lariss Pavilion, northeast of Camp Mojache. (76.7,37.9)| |Z|Feralas|

F Desolace
F Maraudon |N|Enter the instance via the Portal to Inner Maraudon.|
T Splitrock the Elder |N|Jump into Rotgrip's pool, swim to the east and head up the ramp. Turn right and head up a second ramp. The Elder will be in front of you.|
...
T Firebeard the Elder |N|In the Dunwald Ruins. (50.9,70.4)| |Z|Twilight Highlands|
T Darkfeather the Elder |N|In the Thundermar Ruins. (51.8,33.1)| |Z|Twilight Highlands|
...
F Stratholme |N|Enter via the Main Entrance.|
...
T Moonstrike the Elder |N|On top of the Scholomance Tower, outside of the instance. (69.2,73.4)| |Z|Western Plaguelands|
T Meadowrun the Elder |N|Inside the Weeping Cave. (63.5,36.1)| |Z|Western Plaguelands|

F Tirisfal Glades
T Graveborn the Elder |N|Inside Brill. (61.8,53.9)| |Z|Tirisfal Glades|

F Silverpine Forest
T Obsidian the Elder |N|Inside the Sepulcher. (44.9,41.1)| |Z|Silverpine Forest|

F Undercity
T Darkcore the Elder |N|In the middle of the old throne room, surface level. (67.4,39.1)| |Z|Undercity|

F Moonglade |N|Stand in the big beam of light in the middle of the Throne Room and use your Lunar Invitation, or use your Teleport spell if you are a Druid.| |U|21711|
T Valadar Starsong |N|(54,35)| |QID|8883| |Z|Moonglade|

F Winterspring
T Stonespire the Elder |N|In the center of Everlook. (59.9,49.9)| |Z|Winterspring|
T Brightspear the Elder |N|In the ruins of Kel'Theril. (53.2,56.7)| |Z|Winterspring|

F Mount Hyjal
T Evershade the Elder |N|Outside the Nordrassil Inn. (62.5,22.8)| |Z|Mount Hyjal|
T Windsong the Elder |N|At the Sanctuary of Malorne. (26.6,62)| |Z|Mount Hyjal|

F Felwood
T Nightwind the Elder |N|North of Jaedenar. (38.3,52.8)| |Z|Felwood|
...
R Darnassus |N|Hearth to Stormwind, use the boat from the southernmost pier. If you are a Druid, teleport to Moonglade and fly.|
T Bladeswift the Elder |N|In the Cenarion Enclave. (39.2,31.8)| |Z|Darnassus|
T Bladeleaf the Elder |N|Southern edge of Dolanaar. (56.8,53.1)| |Z|Teldrassil|

F Darkshore |N|Take the free taxi ride from the Dolanaar flight master to save time.|
T Starweave the Elder |N|Outside Lor'danel. (49.5,18.9)| |Z|Darkshore|

H Stormwind |N|Take the boat from Rut'theran Village if your Hearthstone is on cooldown.|
b Borean Tundra |N|Take the boat at the northernmost pier.|
...
F Deepholm |N|Use the portal at the Eastern Earthshrine.|
T Stonebrand the Elder |N|Inside the Temple of Earth. (49.7,54.9)| |Z|Deepholm|
T Deepforge the Elder |N|In Stonehearth. (27.7,69.2)| |Z|Deepholm|

H Stormwind City |N|Use the portal in the Temple of Earth if your Hearthstone is on cooldown.|
F Shimmering Expanse |N|Use the portal to Vashj'ir at the Eastern Earthshrine.|
T Moonlance the Elder |N|In the Biel'aran Ridge. (57.2,86.1)| |Z|Shimmering Expanse|
